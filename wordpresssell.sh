...
sudo wp plugin install cloudflare-flexible-ssl --path='/var/www/html' --allow-root
sudo wp plugin activate cloudflare-flexible-ssl --path='/var/www/html' --allow-root
